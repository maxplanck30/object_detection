...
class CameraActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        model = LiteModelEfficientdetLite0DetectionMetadata1.newInstance(this)
            ...
            override fun onSurfaceTextureUpdated(p0: SurfaceTexture) {
                ...
                scores.forEachIndexed { index, fl ->
                    ...
                    if(fl > 0.5){
                        ...
                        canvas.drawText(labels.get(classes.getIntValue(index)) + " "+fl.toString(), locations.get(x+1)*w, locations.get(x)*h, paint)
                    }
                }
